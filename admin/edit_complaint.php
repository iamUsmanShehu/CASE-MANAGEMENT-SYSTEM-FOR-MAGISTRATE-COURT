...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM `direct_complaints` WHERE id=$id";
...
if (isset($_POST['update'])) {
    ...
    $updateQuery = "UPDATE `direct_complaints` SET 
    ...
    if ($conn->query($updateQuery) === TRUE) {
        ...
        header('Location: manage-direct-case.php'); // Redirect to the main table display page
    } else {
...
<head>
    ...
    <style type="text/css">
        ...
        input[type=text], input[type=password], select, input[type=datetime-local], textarea{
          width: 100%;
          padding: 15px;
          margin: 5px 0 22px 0;
    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                <h2>Edit Direct Complaint Record</h2>
                <form method="POST" action="">
                    ...
                    <textarea name="statement" required><?php echo $row['statement']; ?></textarea><br>

                    <label for="submission_date">Submission Date</label>
                    <input type="datetime-local" name="submission_date" value="<?php echo $row['submission_date']; ?>" required><br>
